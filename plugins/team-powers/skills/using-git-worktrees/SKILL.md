...
2. ~/.config/team-powers/worktrees/<project-name>/ (global location)
...
### For Global Directory (~/.config/team-powers/worktrees)
...
case $LOCATION in
  .worktrees|worktrees)
    ...
    ;;
  ~/.config/team-powers/worktrees/*)
    path="~/.config/team-powers/worktrees/$project/$BRANCH_NAME"
    ;;
esac
