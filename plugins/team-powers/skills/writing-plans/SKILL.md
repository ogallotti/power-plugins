...
**Context:** This should be run in a dedicated worktree (created via `team-powers:using-git-worktrees`, typically invoked by brainstorming before reaching this skill).

**Save plans to:** `docs/team-powers/plans/YYYY-MM-DD-<feature-name>.md`
...
**"Plan complete and saved to `docs/team-powers/plans/<filename>.md`. Ready to execute?"**
